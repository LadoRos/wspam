...
echo "
      ...
      ==             |_|  |_|_| \_\ (_)   |_|    |_|/_/\_\          ==
      ==                                                            ==
      ==             TOLONG  MASUKAN NOMOR PAKAI FORMAT[+62]        ==
      ================================================================\n";
echo "[+]Nomor Target?\n[+]Input : ";
...
echo "[+]Target: $nomer sudah benar? (y/n)";
...
X-CSRF-Token: uYUfi93g92mZboBVB4UMwYInorBNOgyYEAbPUTikHht+xseF8BFUgg9qSgQWA9MRy7eL8G/SnbYUGg0                       >
User-Agent: Mozilla/5.0 (Linux; Android 7.1.2; Redmi 4X Build/N2G47H) AppleWebKit/537.36 (KHT                       >
...
Cookie: identity=".$rand1."; browser_id=".$rand2."; _ga=GA1.2.1024758930.1531960985; _vwo_uui                       >
        global $config;
